...
- Foundation-model adaptation is publishable only if it beats a strong baseline and improves transfer, label efficiency, external validation, or workflow.
- Report pretraining data, frozen/fine-tuned layers, adaptation method, hyperparameter selection, and test-set isolation.
...
| Fairness | age/sex/site/scanner subgroup performance where available | underrepresented subgroup sensitivity and mitigation plan |

...
| 6-9 months | Establish strong baselines: clinical model, IBSI radiomics, CNN/ViT or nnU-Net model | Reproducible baseline, internal test, failure-case library | `radiology-stats`, `radiology-deep-learning`, `radiology-figure` |
...
| 18-24 months | Silent deployment, reader-assist, workflow/time/error endpoint, or prospective validation preparation | Prospective/reader study, CLAIM/TRIPOD/STARD package plus DECIDE-AI (early clinical evaluation, Nat Med 2022) / CONSORT-AI (if a randomised trial) → radiology-reporting routing, regulatory-readiness notes | `radiology-translation`, `radiology-reporting`, `radiology-journal` |
...
| Reader-assist deployment | Human-AI interaction, workflow, error/time endpoints | Autonomous use |
| Silent (non-interactive) deployment | Workflow/time endpoints only | Human-AI interaction evidence, clinical utility or autonomous use |

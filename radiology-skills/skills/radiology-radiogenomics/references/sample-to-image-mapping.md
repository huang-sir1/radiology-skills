...
After assigning the strongest defensible mapping level, use `radiomics-mechanism-bridge.md` to
limit the mechanism canvas and writing to that same patient/lesion/region/section scale.

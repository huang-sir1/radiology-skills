...
## Privacy frameworks (name the current one that applies; defer specifics to the institution)
...
The table is routing context, not a current legal determination. Verify jurisdiction, institution,
policy version/accessed date and the responsible privacy/legal owner for the specific project.

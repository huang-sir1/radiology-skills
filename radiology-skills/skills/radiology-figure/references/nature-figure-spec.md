...
the _Radiology_ workflow, different numbers. Select the predefined `SINGLE_NATURE, DOUBLE_NATURE`
constants in `api.md` for a Nature-family run (89/25.4, 183/25.4 inches) instead of editing or
reusing the 85/170 mm _Radiology_ constants.

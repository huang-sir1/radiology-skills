...
> (Nature-family: numbered, in citation order → `radiology-citation`/`export-formats.md`, section
> "Venue reference styles (Vancouver/ICMJE)"; not the AMA-numbered style assumed elsewhere in
> this file).
...
- **Do** use leading zero for values that can exceed 1 (HR .85 is wrong → HR can be <1 but

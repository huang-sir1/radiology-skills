...
- **NCI Imaging Data Commons (IDC)** — cloud analysis entry point for TCIA data (DICOM in
  cloud buckets + BigQuery metadata); use alongside TCIA for cohort building and filtering.
...
- **GDC / TCGA**, **cBioPortal**, **GEO/ArrayExpress** (expression incl. single-cell;
  ArrayExpress retired 2022 — legacy accessions resolve via EMBL-EBI BioStudies),
